...
const recordTypes = {
  announcements: { label: 'Announcements', collection: 'announcements', kicker: 'School updates', fields: ['title', 'body', 'audience', 'status'], defaults: { audience: 'all', status: 'draft' } },
...
export function ContentManagementPage() {
  ...
  const columns = useMemo(() => activeType === 'alumni' ? ['Name', 'Graduation year', 'Contact', 'Status'] : activeType === 'announcements' ? ['Title', 'Audience', 'Status', 'Updated'] : ['Title', 'Category', 'Status', 'Updated'], [activeType])
